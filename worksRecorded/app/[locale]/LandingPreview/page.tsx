		...
		>
			...
			<header className="sticky top-0 z-40 border-b border-[#e6ece7] bg-white/90 backdrop-blur-xl">
				<div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
					<Link
						href={`/${locale}/LandingPreview`}
						className="flex items-center gap-3"
					>
						<span
							className="text-2xl font-semibold tracking-[-0.04em] text-[#101610]"
					...
					<div className="flex items-center gap-2">
						...
						<div className="hidden sm:block">
							<LoginLink>
								<button
									type="button"
									className="inline-flex h-10 rounded-full px-4 text-sm font-medium text-[#354038] transition hover:bg-[#f4f7f4]"
								>
									{auth("signIn")}
								</button>
							</LoginLink>
