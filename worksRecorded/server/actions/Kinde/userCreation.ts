...
// =====================
// HARD-CODE USER HEREa
// =====================
const USERNAME = "Vladimir_Nikitins";
const PASSWORD = "v9#Lq2!Tz7@Np4$Rx8&K"; // will be bcrypt-hashed
const GIVEN_NAME = "Vladimir";
const FAMILY_NAME = "Nikitins";
