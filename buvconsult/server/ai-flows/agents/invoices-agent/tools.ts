...
import { nukeBackslashes, SQLexecute } from "@/server/ai-flows/agents/invoices-agent/functions";
...
export const SQL_invoice_database_query_tool= new DynamicStructuredTool({
  name: "postgreSQL_invoice_database_query_tool",
...
export const tools = [SQL_invoice_database_query_tool]
