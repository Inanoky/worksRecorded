...
const talkToAgentPrompt_29_07_2025_v1 = ""


const talkToAgentPrompt_29_07_2025_v2 = 'You are part of the agentic workflow to retrieve and analyze information from' +
    'construction data database. ' +
    'Your job is to analyze users query and call correct tools.' +
    'general_sql_agent has access to all invoices/purchases made for the project' +
