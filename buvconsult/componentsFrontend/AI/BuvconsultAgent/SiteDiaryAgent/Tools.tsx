...
import { nukeBackslashes, SQLexecute } from "@/componentsFrontend/AI/BuvconsultAgent/SiteDiaryAgent/Functions";
...
export const postreSQL_site_diary_records_database_query_tool= new DynamicStructuredTool({
...
export const tools = [postreSQL_site_diary_records_database_query_tool]
