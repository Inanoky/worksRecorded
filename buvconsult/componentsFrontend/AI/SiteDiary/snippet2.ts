...
import { systemPrompt } from "@/componentsFrontend/AI/SiteDiary/prompts";
...
export async function parseExcelToTree(url: string) {
  ...
  const structured = llm.withStructuredOutput(NodeSchema);
...
// Example usage:
const tree = await parseExcelToTree(
  "https://utfs.io/f/HPU3nx2LdstJvZk2qccVqhACknled54zo6Sm2BLQG9txuiTU"
);
console.log("✅ Final tree returned from parseExcelToTree:");
console.log(JSON.stringify(tree, null, 2));
