"use client";
import { ScrollTable } from "@/componentsFrontend/templates/scrollAreaTemplate";
import { Card, CardTitle, CardHeader, CardContent, CardFooter } from "@/componentsFrontend/ui/card";
